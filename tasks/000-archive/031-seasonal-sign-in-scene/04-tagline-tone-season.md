...
- [x] A page tone is chosen, deeper or the app's, and either folded into the brand tokens (task 029) or kept to the sign-in page.
- [x] How the app picks the season is decided, for example by month, flipped for the southern
