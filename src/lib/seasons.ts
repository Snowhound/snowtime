...
// `title` and `sub` are the intro's headline and second line on the dark scene. `titleLight` is the headline's hue darkened for the tagline on light pages, at least
