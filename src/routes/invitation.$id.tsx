...
import { AuthHeading, AuthIcon, AuthLayout } from '~/components/auth/auth-layout'
import { FormAlert, PasswordSignIn, ProviderButtons } from '~/components/auth/sign-in-methods'
import { Avatar, AvatarFallback } from '~/components/ui/avatar'
import { Button } from '~/components/ui/button'
import { getInvitation } from '~/functions/auth'
import { authClient } from '~/lib/auth-client'
import { sessionQuery } from '~/lib/session'
import { m } from '~/paraglide/messages.js'
import { Uuidv7 } from '~/schemas/common'
...
function Invitation() {
  ...
  const invitation = useQuery(() => invitationQuery(params().id))
