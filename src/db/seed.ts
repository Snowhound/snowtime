...
const projects = [
  ...
  { id: P.mobile, org: O.northwind, name: 'Mobile app', color: '#d9703f', teams: [T.engineering] },
  { id: P.internal, org: O.northwind, name: 'Internal', color: '#1f9e8a', teams: [] },
  {
    id: P.legacy,
    org: O.northwind,
    name: 'Legacy CRM',
  ...
  { id: P.onboarding, org: O.harbor, name: 'Client onboarding', color: '#4f8f3a', teams: [] },
  { id: P.audit, org: O.harbor, name: 'Audit', color: '#c9514f', teams: [T.delivery] },
]
